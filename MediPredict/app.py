...
diabetes_model = pickle.load(open(r'C:\Users\kalai\OneDrive\Mini Project-Medi predict\Mini Project\diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open(r'C:\Users\kalai\OneDrive\Mini Project-Medi predict\Mini Project\heart_disease_model.sav', 'rb'))
